...
// Creating the widget
	...
	// Checking for the animation hover	
		
	 if($hover_animation=='none') { $spoontalk_hover_animation="none";} 
	 else if($hover_animation=='rotate') { $spoontalk_hover_animation="spoontalk-rotate";}  
	 else if($hover_animation=='grow-rotate') { $spoontalk_hover_animation="hvr-grow-rotate";}  
	 else if($hover_animation=='shrink') { $spoontalk_hover_animation="hvr-shrink";}  
	 else if($hover_animation=='wobble') { $spoontalk_hover_animation="hvr-wobble-to-bottom-right";}  
	 else if($hover_animation=='wobble-vertical') { $spoontalk_hover_animation="hvr-wobble-vertical";}  
	 else if($hover_animation=='buzz') { $spoontalk_hover_animation="hvr-buzz";}
