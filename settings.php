   ...
   <div class="format-setting-wrap">
    ...
    <table class="form-table">									
		...
		<tr valign="top">
		 ...
		 <td><select id="hover_animation" name="hover_animation">
	
		<option  <?php
		if ($hover_animation=="none") echo 'selected="selected"';  ?>  ><?php _e('none',''); ?></option>
		<option  <?php
		if ($hover_animation=="rotate") echo 'selected="selected"';  ?>  ><?php _e('rotate',''); ?></option>
			<option  <?php
		if ($hover_animation=="grow-rotate") echo 'selected="selected"';  ?>  ><?php _e('grow-rotate',''); ?></option>
		<option  <?php
		if ($hover_animation=="shrink") echo 'selected="selected"';  ?>  ><?php _e('shrink',''); ?></option> 
			<option  <?php
		if ($hover_animation=="wobble") echo 'selected="selected"';  ?>  ><?php _e('wobble',''); ?></option> 
			<option  <?php
		if ($hover_animation=="wobble-vertical") echo 'selected="selected"';  ?>  ><?php _e('wobble-vertical',''); ?></option> 
				<option  <?php
		if ($hover_animation=="buzz") echo 'selected="selected"';  ?>  ><?php _e('buzz',''); ?></option> 
		</select><label for="size">px</label><p class="description">select the hover animation effect </p></td>
